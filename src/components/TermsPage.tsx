...
const TermsPage = () => (
  <Wrap>
    <ContentWrap>
      ...
      <Content>
        Team EXIT('https://wagglewaggle.co.kr'이하 '와글와글')은 「개인정보
        보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을
        신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보
        처리방침을 수립·공개합니다. 이 개인정보처리방침은 2023년 2월 20일부터
        적용됩니다.
      </Content>
      <SubTitle>제1조(개인정보의 처리 목적)</SubTitle>
      <Content>
        Team EXIT(와글와글)은 다음의 목적을 위하여 개인정보를 처리합니다.
      ...
      <Content>
        ① Team EXIT은 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
      ...
      <Content>
        ① Team EXIT은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
      ...
      <Title />
      <Content>
        1. 파기절차 Team EXIT은 파기 사유가 발생한 개인정보를 선정하고, Team
        EXIT의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
      </Content>
      <Title />
      <Content>
      ...
      <Content>
        ① 정보주체는 Team EXIT에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
        요구 등의 권리를 행사할 수 있습니다.
      </Content>
      <Title />
      <Content>
        ② 제1항에 따른 권리 행사는Team EXIT에 대해 「개인정보 보호법」 시행령
        제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
        있으며 Team EXIT은(는) 이에 대해 지체 없이 조치하겠습니다.
      </Content>
      <Title />
      <Content>
      ...
      <Title />
      <Content>
        3. 해킹 등에 대비한 기술적 대책 Team EXIT('와글와글')은 해킹이나 컴퓨터
      ...
      <Title />
      <Content>
        4. 개인정보에 대한 접근 제한 개인정보를 처리하는 데이터베이스 시스템에
        대한 접근권한의 부여,변경,말소를 통하여 개인정보에 대한 접근·통제를
        위하여 필요한 조치를 하고 있으며 침입·차단 시스템을 이용하여
        외부로부터의 무단 접근을 통제하고 있습니다.
      </Content>
      <Title />
      <Content>
        5. 비인가자에 대한 출입 통제 개인정보를 보관하고 있는 물리적 보관 장소를
      ...
      <Content>
        ① 행태정보의 수집·이용·제공 및 거부등에 관한 사항 Team EXIT은 온라인
        맞춤형 광고 등을 위한 행태정보를 수집·이용·제공하지 않습니다.
      </Content>
      <SubTitle>제8조(추가적인 이용·제공 판단기준)</SubTitle>
      <Content>
        Team EXIT은 ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라
        ｢개인정보 보호법 시행령｣ 제13조의2에 따른 사항을 고려하여 정보주체의
        동의 없이 개인정보를 추가적으로 이용·제공할 수 있습니다. 이에 따라 Team
        EXIT이 정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서 다음과 같은
        사항을 고려하였습니다.
      </Content>
      <Content>
      ...
      <Content>
        Team EXIT은 다음과 같은 목적으로 가명정보를 처리하고 있습니다.
      </Content>
      <TermsWithLists
        title="▶ 가명정보의 처리 목적"
        lists={[
      ...
      <Content>
        ① Team EXIT은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
      ...
      <TermsWithLists
        ...
        lists={[
          "성명 : 김경식",
          "직책 : 개발자",
          "연락처 : 01020390759, kskim625@gmail.com",
        ]}
      />
      <Title />
      <Content>
        ② 정보주체께서는 Team EXIT의 서비스(또는 사업)을 이용하시면서 발생한
        모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
        개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. Team EXIT은
        정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
      </Content>
      <SubTitle>제11조(개인정보의 열람청구를 접수·처리하는 부서)</SubTitle>
      <Content>
        정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의
        부서에 할 수 있습니다. Team EXIT은 정보주체의 개인정보 열람청구가
        신속하게 처리되도록 노력하겠습니다.
      </Content>
      <TermsWithLists
